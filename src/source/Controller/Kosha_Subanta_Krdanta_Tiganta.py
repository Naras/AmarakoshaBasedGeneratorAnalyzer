...
from ..Controller import Sandhi_Convt, Transliterate, blast
from ..Controller.Transliterate import transliterate_lines, IndianLanguages
from ..Model import AmaraKosha_Database_Queries
                                    ...
                                    for subformItemNo, subformItem in enumerate(subforms):
                                        for tstr in subformItem.split('/'):
                                            if Sandhi_Convt.Sandhi(subDetailsRec.erb + tstr) == word:
                                                ...
                                                #         subDetail.anta = entry[2]  # equivalent of Right$(antas(i), Len(antas(i)) - 2) in VB code
                                                #         if subantaDetailRec[cols_subanta.index('Code')][0] == 'A': subDetail.anta += "ान्तः"  # ÚÆèÂ£
                                                #         else: subDetail.anta += "कारान्तः"  # ³ÚÏÚÆèÂ£
                                                #         break
